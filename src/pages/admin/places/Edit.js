...
function PlaceEdit() {
    ...
    const getPlaceById = async () => {
        ...
        await Api.get(`/api/admin/places/${id}`, {
            ...
            setOffice_hours(response.data.data.office_hours);
    ...
    const updatePlace = async (e) => {
        ...
        await Api.post(`/api/admin/places/${id}`, formData, {
            ...
            //show toast success message "Updated Place success"
            toast.success('Updated Place success', {
                duration: 4000,
                position: "top-right",
                style: {
                    borderRadius: "10px",
            ...
            //show toast error message "Updated Place fail"
            toast.error('Updated Place fail', {
                duration: 4000,
                position: "top-right",
                style: {
                    borderRadius: "10px",
